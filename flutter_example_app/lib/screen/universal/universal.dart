...
import '../../common/listener.dart';

class Universal extends StatefulWidget {
  UniversalState createState() => UniversalState();
}

class UniversalState extends State<Universal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Builder(builder: (context) {
        ...
        bodyHeight = MediaQuery.of(context).size.height - Scaffold.of(context).appBarMaxHeight!.toDouble();
        return Stack(
          children: <Widget>[
            Center(
              child: Column(
