...
import VisxAdContainer from "../modules/banner/VisxFixedSizeBanner";
import * as constants from "../constants";
import { useState } from "react";

export default function Banner() {
  console.log("RN Code: Banner Screen START! Platform: " + Platform.OS);
  ...
  if (Platform.OS === "ios") {
    ...
    console.log("RN Code: Banner Screen START! Unsupported Platform");
  }
