...
/// Handling VIS.X Inline Banner/Video Ad
@interface VisxBannerView: RCTViewManager <VisxAdViewDelegate>

/*!
 * VIS.X Inline Banner/Video Ad Instance
 */
 ...
 */
RCT_EXPORT_MODULE(VisxBannerView)
...
- (void)loadAd {
  ...
  self.adView = [[VisxAdView alloc] initWithAdUnit:@"912261"
                                         appDomain:@"yoc.com"
                                    adViewDelegate:self
                                            adSize:[VisxAdSize kSmartphoneBanner300x75]
                                         universal:YES];
  [self.adView load];
}
 ...
 *  Stop VIS.X Ad
 */
- (void)deinitVisxAdView {
  [self.adView deallocAdView];
}
